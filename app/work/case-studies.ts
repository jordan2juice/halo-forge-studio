...
export const CASE_STUDIES: CaseStudy[] = [
    ...
    images: [
      {
        ...
        alt: "St. Gabriel Catholic Parish website homepage redesigned by Halo Forge Studio — desktop view",
        caption:
          "Redesigned homepage highlighting Mass times, sacraments, and events.",
      },
      {
        src: "/images/case-studies/st-gabriel/stg-mobile.png",
        alt: "St. Gabriel Catholic Parish website Mass times section — mobile view",
    ...
    images: [
      {
        ...
        alt: "Little Crown Rosaries brand identity — logo, color palette, and typography by Halo Forge Studio",
        caption: "Brand system balancing Marian blues with warm neutrals.",
      },
      {
        src: "/images/case-studies/little-crown/lcr-shop.png",
        alt: "Little Crown Rosaries ecommerce product grid designed by Halo Forge Studio",
    ...
    images: [
      {
        ...
        alt: "Emmaus Outreach Ministry website homepage designed by Halo Forge Studio",
        caption:
      ...
      },
      {
        ...
        alt: "Emmaus Outreach Ministry three-path navigation layout for parishes, individuals, and supporters",
        caption:
      ...
      },
      {
        ...
        alt: "Emmaus Outreach Ministry mobile events list designed by Halo Forge Studio",
        caption:
  ...
  },
  {
    ...
    sector: "Faith-Informed Counseling",
    tags: ["Web design", "Catholic counseling", "Faith-informed"],
    images: [
      {
        src: "/images/case-studies/hope-harbor/hh-homepage.png",
        alt: "Hope & Harbor Counseling website homepage designed by Halo Forge Studio",
        caption:
      ...
      },
      {
        ...
        alt: "Hope & Harbor Counseling services and specialties page layout",
        caption:
      ...
      },
      {
        ...
        alt: "Hope & Harbor Counseling mobile intake form designed by Halo Forge Studio",
        caption:
    ...
    images: [
      {
        ...
        alt: "Cedar & Cross Catholic gift shop ecommerce homepage designed by Halo Forge Studio",
        caption:
      ...
      },
      {
        ...
        alt: "Cedar & Cross Catholic gift shop product collection grid by Halo Forge Studio",
        caption:
      ...
      },
      {
        ...
        alt: "Cedar & Cross Catholic gift shop mobile product detail page",
        caption:
  ...
  },
  {
    ...
    solution:
      "The site was reorganized around three primary paths — individual retreats, parish/group retreats, and clergy days — each with clear descriptions, pricing, and FAQs. A calm, image-light layout using Halo Forge's dusk, gold, and linen palette makes key information easy to scan, while an availability calendar and simple inquiry form reduce back-and-forth emails.",
    outcome:
    ...
    images: [
      {
        ...
        alt: "Holy Mountain Catholic Retreat Center website homepage designed by Halo Forge Studio",
        caption:
          "Homepage featuring clear retreat paths for individuals, parishes, and clergy.",
      },
      {
        src: "/images/case-studies/holy-mountain/hm-calendar.png",
        alt: "Holy Mountain Retreat Center availability calendar interface",
        caption:
      ...
      },
      {
        ...
        alt: "Holy Mountain Retreat Center mobile inquiry form designed by Halo Forge Studio",
        caption:
