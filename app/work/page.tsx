...
export default function WorkPage() {
  return (
    <>
      ...
      {/* ASYMMETRIC DECK SHOWCASE GRID */}
      <main className="mx-auto max-w-5xl px-6 sm:px-8 pb-32">
        <section className="grid gap-10 md:gap-14 md:grid-cols-2">
          {CASE_STUDIES.map((cs, index) => {
            // Janda style layout trick: Give the second card an offset margin on desktop
            // to break up uniform template monotony and make it look like an architectural gallery layout
